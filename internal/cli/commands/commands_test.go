...
func TestInstallCommandErrors(t *testing.T) {
	tests := []struct {
		name        string
		setup       func(t *testing.T) (string, string) // Returns packageDir, projectDir
		presetName  string
		target      string
		wantErr     bool
		errContains string
...
func TestTransformCommandErrors(t *testing.T) {
	tests := []struct {
		name        string
		setup       func(t *testing.T) (string, string) // Returns packageDir, presetName
		target      string
		wantErr     bool
		errContains string
	}{
...
func TestListCommandErrors(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setup: func(t *testing.T) string {
				// Don't set CURSOR_RULES_PACKAGE_DIR
				return t.TempDir()
			},
			wantErr: false, // Should handle gracefully
		},
